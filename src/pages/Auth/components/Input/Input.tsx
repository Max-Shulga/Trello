...
import passwordSecurityWithSlashImg from '../../../../assets/passwordSecurityWithSlashImg.svg';
    ...
    return (
      <label className={styles.inputContainer}>
        ...
        {type === 'password' && (
          ...
          >
            <img
              src={showPassword ? passwordSecurityImg : passwordSecurityWithSlashImg}
              alt="password security eye"
